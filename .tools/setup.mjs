...
function generateFolderIndex() {
  const folders = {
    ...
    '98-output': {
      description: 'Generated PDFs and conversion tools',
      subfolders: {}
    },
    '99-meta': {
...
function generateTemplateIndex() {
  const templates = [
    ...
    { path: '01-formation/organizational-resolutions/_initial-directors-resolution-template.md', name: 'Initial Directors Resolution', category: 'formation' },
    ...
    { path: '01-formation/organizational-resolutions/_share-issuance-resolution-template.md', name: 'Share Issuance Resolution', category: 'formation' },
    { path: '01-formation/organizational-resolutions/_general-share-authorization-template.md', name: 'General Share Authorization', category: 'formation' },
    { path: '01-formation/ontario-extra-provincial/_ontario-registration-template.md', name: 'Ontario Extra-Provincial Registration (Formation)', category: 'formation' },
    ...
    { path: '05-capitalization/share-issuances/0000-templates/_issuance-summary-template.md', name: 'Issuance Summary', category: 'capitalization' },
    ...
    { path: '06-regulatory-filings/ontario/extra-provincial/_initial-registration-template.md', name: 'Ontario Extra-Provincial Registration (Filing)', category: 'regulatory' },

    { path: '_TODO-template.md', name: 'Corporate Document Checklist', category: 'meta' },
...
function generateRegisterIndex() {
  const registers = [
    ...
    { path: '03-registers/shareholders-register.csv', name: 'Shareholders Register', schema: ['id', 'shareholder_name', 'address', 'share_class', 'number_of_shares', 'issue_date', 'certificate_number', 'unanimous_shareholders_agreement_signatory'] },
    { path: '03-registers/securities-register.csv', name: 'Securities Register', schema: ['id', 'security_type', 'holder_name', 'number_issued', 'issue_date', 'consideration', 'certificate_number', 'cancelled_date', 'transfer_restrictions'] },
    ...
    { path: '05-capitalization/options-and-ESOP/option-grants-register.csv', name: 'Option Grants Register', schema: ['grant_id', 'employee_name', 'number_of_options', 'strike_price', 'grant_date', 'vesting_start', 'vesting_terms', 'expiration_date', 'status'] },
  ];
  ...
  const workflows = {
    'initial-setup': {
      ...
      steps: [
        ...
        { id: 'create-initial-directors-resolution', name: 'Create initial directors resolution', description: 'Acknowledge initial director(s) and confirm authority', dependsOn: ['record-initial-director'] },
        { id: 'create-organizational-resolution', name: 'Create organizational resolution', description: 'Adopt bylaws, appoint officers, authorize shares, establish registers, authorize registrations', dependsOn: ['create-initial-directors-resolution'] },
        ...
        { id: 'issue-founder-shares', name: 'Issue founder shares', description: 'Create share issuance resolution, certificate, and issuance summary', dependsOn: ['create-organizational-resolution'] },
        { id: 'create-general-share-authorization', name: 'Create general share authorization', description: 'Authorize future share issuances, equity incentive pool, and procedures', dependsOn: ['issue-founder-shares'] },
